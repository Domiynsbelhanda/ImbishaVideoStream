...
public class urbaine_accueil extends Fragment implements itemClick, DownloadClick {

    private static final int PERMISSION_STORAGE_CODE = 1000 ;
    private urbaine_view_model urbaineviewmodel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        urbaineviewmodel =
                ViewModelProviders.of(this).get(urbaine_view_model.class);
        View root = inflater.inflate(R.layout.fragment_urbaine, container, false);

        modele  = root.findViewById(R.id.recycler_view_urbaine);
        ...
        reference = reference.child("Urbaine");
        ...
        @SuppressLint("StaticFieldLeak") YouTubeUriExtractor ytEx = new YouTubeUriExtractor(getActivity()) {
            ...
            public void onUrisAvailable(String videoId, String videoTitle, SparseArray<YtFile> ytFiles) {
                if (ytFiles != null) {
                    ...
                    Toast.makeText(getActivity(), String.valueOf(itag), Toast.LENGTH_LONG).show();
